        ...
        while (true) {
            ...
            try {
                ...
                if (response.isCorrect()) {
                    ...
                    System.out.format("Ошибка регистрации\n%s:%s", response.getStatusCode(), response.getBody());
                }
            } catch (Exception e) {
        ...
        while (true) {
            ...
            try {
                ...
                if (response.isCorrect()) {
                    ...
                    System.out.format("Ошибка входа\n%s:%s", response.getStatusCode(), response.getBody());
                }
            } catch (Exception e) {
                System.out.println("Ошибка подключения: " + e.getMessage());
            }
    ...
    private void loadNotesFromServer() {
        try {
            ...
            if (response.isCorrect()) {
                ...
                System.out.format("Ошибка при загрузке заметок\n%s:%s", response.getStatusCode(), response.getBody());
